pipeline {
    ...
    stages {
        stage('拉取代码') {
            steps {
                //拉取git仓库代码
                git branch: 'main', url: 'https://github.com/center6677889/follow-admin.git'
            }
        }
        stage('安装依赖') {
            steps {
        ...
        stage('telegram') {
            steps {
                script {
                    def telegramToken = '7740555455:AAHh1l1ZulVFxihO0LTUBIzhNyUTQhvsIK4'
                    def chatId = '-4785655126'
